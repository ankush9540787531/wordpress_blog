 ...
 */
 ...
 # Load Redux Tag Value
 $sidebar = esc_html($tada_theme['sidebar-tag']);
 if(!isset($sidebar) || $sidebar == '') : $sidebar = 'sidebar-right'; endif; 
 
 $layout_type = esc_html($tada_theme['layout-tag']);
     ...
     <!-- start:sidebar none - full width -->
        <div class="content col-xs-12 <?php echo esc_html($layout_type); ?>">
        	<div class="post-text tada-title-page">
                    <h2 class="generic-title-page"><?php printf( esc_html__( 'Tag Archives: %s', 'tada' ), single_tag_title( '', false ) ); ?></h2>
             </div>                 
             <!-- start:page content -->
             <?php 
