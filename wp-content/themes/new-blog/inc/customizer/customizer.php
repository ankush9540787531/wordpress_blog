...
$post_taxonomy_arrays = array(__('Category','new-blog'),__('Date','new-blog'),__('Comment','new-blog'),__('Tag','new-blog'),__('ReadMore','new-blog'),__('UseBlankImage','new-blog'));
foreach ($post_taxonomy_arrays as  $post_taxonomy) {
...
$post_taxonomy_arrays = array(__('Category','new-blog'),__('Date','new-blog'),__('Excerpt','new-blog'),__('Tag','new-blog'),__('ReadMore','new-blog'),__('UseBlankImage','new-blog'));
foreach ($post_taxonomy_arrays as  $post_taxonomy) {
